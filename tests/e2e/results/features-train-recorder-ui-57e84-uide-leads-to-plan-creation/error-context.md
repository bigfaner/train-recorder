...
- Name: features/train-recorder/ui.spec.ts >> Train Recorder UI E2E Tests >> Plan Management >> TC-UI-001: First-use empty state guide leads to plan creation
- Location: features/train-recorder/ui.spec.ts:9:5
...
Locator: getByTestId('empty-state-guide')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByTestId('empty-state-guide')
