...
Read each record file from `docs/features/train-recorder/tasks/records/` whose filename starts with `4.` and does NOT contain `.summary`.
...
- All phase task records: `docs/features/train-recorder/tasks/records/4.*.md`
